public class BagClient {
	...
	Bag b4 = new Bag(10);
	// add values
        b4.add(45); b4.add(-7); b4.add(8); b4.add(15); 
        b4.add(-1); b4.add(14); b4.add(23);
	...
	System.out.println("b4 = " + b4);
        ...
        Bag b5 = new Bag(5);
	b5.add(12); b5.add(3); b5.add(7); b5.add(12);
	System.out.println("b5 = " + b5);
        Bag b6 = new Bag(5);
	b6.add(3); b6.add(7); b6.add(12); b6.add(12);
